"""
Django settings for sshock project.
...
SECRET_KEY = '*l1-rw)-fi*$g4hnjez9b!%!fcxk^=*rqs#$@igthtk@dw#w#c'
...
WSGI_APPLICATION = 'sshock.wsgi.application'
